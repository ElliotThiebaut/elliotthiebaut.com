...
// Animation to change text in landing page
if (window.location.pathname == '/C:/Users/Elliot/OneDrive/Documents/PRO/Site%20perso/index.html') {
  // let titleIntro = document.querySelector("#studies");
  // let textIntro = ['développement web', 'webdesign', 'vidéo / motion design', 'design graphique', 'animation 3D']

  // let i = 0;

  // function changeText() {
  //     titleIntro.classList.add("uk-animation-slide-top");
  //     titleIntro.innerHTML = textIntro[i];
  //     i++;
  //     if (i == 4) {
  //         i = 0;
  //     }
...
// See more in about page
if (window.location.pathname == '/C:/Users/Elliot/OneDrive/Documents/PRO/Site%20perso/about.html') {
